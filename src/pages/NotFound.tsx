...
const NotFound = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#240015] via-[#12000b] to-[#1a0012]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <svg
          ...
          y="0px"
          viewBox="0 0 700 250"
          className="absolute h-auto w-[600px] max-w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-hue-rotate"
        >
          <defs>
            <filter id="glow">
        ...
        >
          <g>
            <path
              ...
              fill="transparent"
              filter="url(#glow)"
              strokeDasharray="940px"
              strokeDashoffset="-940px"
              style={{
            ...
            <path
              ...
              fill="transparent"
              filter="url(#glow)"
              strokeDasharray="735px"
              strokeDashoffset="-735px"
              style={{
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-4 flex flex-col items-center justify-center min-h-screen space-y-8">
        {/* Top Title */}
        <h2
          ...
          style={{
            ...
            color: "#79d153",
            textShadow: "0px 0px 14px #79d153",
        ...
        {/* Spacer for the 404 SVG effect */}
        <div className="h-[300px] w-full flex items-center justify-center">
          {/* SVG effects are already rendered above */}
        </div>
        
        {/* Bottom Content */}
        <div className="flex flex-col items-center space-y-6">
          <p className="text-lg md:text-xl text-gray-300 animate-fade-in max-w-xl">
          ...
          <Button
            ...
            size="lg"
            className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-white font-semibold px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300 group"
          >
      ...
      <style>{`
        ...
        @keyframes flicker4 {
          0% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
          30% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
          31% { color: #12000a; text-shadow: 0px 0px 4px #12000a; }
          32% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
          36% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
          37% { color: #12000a; text-shadow: 0px 0px 4px #12000a; }
          41% { color: #12000a; text-shadow: 0px 0px 4px #12000a; }
          42% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
          85% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
          86% { color: #12000a; text-shadow: 0px 0px 4px #12000a; }
          95% { color: #12000a; text-shadow: 0px 0px 4px #12000a; }
          96% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
          100% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
        }

        @keyframes fadeInText {
          1% { color: #12000a; text-shadow: 0px 0px 4px #12000a; }
          70% { color: #79d153; text-shadow: 0px 0px 14px #79d153; }
          100% { color: #79d153; text-shadow: 0px 0px 4px #79d153; }
        }
